        ...
        <div className="min-h-screen bg-white py-12 px-4">
            <div className="container mx-auto max-w-4xl">
                ...
                <div className="prose prose-lg max-w-none" style={{ color: 'hsl(220, 13%, 13%)', fontFamily: 'Poppins, sans-serif' }}>
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Introduction</h2>
                    <p className="mb-4">
                        This Privacy Policy describes how 9266987400 9266987400
                        and its affiliates (collectively " , we, our, us")
                        collect, use, share, protect or otherwise process your information/ personal data through our website
                        https://www.topshot.co/ Platform
                    ...
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Collection</h2>
                    <p className="mb-4">
                    ...
                    <p className="mb-4">
                        ...
                        any information. If you receive an email, a call from a person/association claiming to be 9266987400
                    ...
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Usage</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Sharing</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Security Precautions</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Data Deletion and Retention</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Your Rights</h2>
                    <p className="mb-4">
                        You may access, rectify, and update your personal data directly through the functionalities
                        provided on the Platform.
                    </p>
                    
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Consent</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-2xl font-semibold mb-4 mt-6">Grievance Officer</h2>
                    <p className="mb-4">
