    ...
    return (
        <>
            <SEO
                ...
                description="Explore Topshot, India's premium pickleball store. Shop professional-grade paddles and high-performance equipment designed for the competitive edge."
                canonical="https://topshot.co/"
                ogTitle="Topshot | Official Paddle Store"
                ogDescription="Discover professional-grade pickleball paddles and gear at Topshot, India's leading pickleball equipment store. Shop now for the competitive edge."
